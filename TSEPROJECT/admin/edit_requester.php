<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        do {
            if (empty($id) || empty($name) || empty($age) || empty($email) || empty($tel) || empty($bloodtype) || empty($message)) {
                $errorMessage = "All the fields are required";
                break;
            }

            $sql = "UPDATE requester " .  
                   "SET name = '$name', age = '$age', email = '$email', tel = '$tel', bloodtype = '$bloodtype', message = '$message' " .
                   "WHERE id = $id";
            $result = $conn->query($sql);
            ...
            $successMessage = "Requester updated correctly";
...
<body>
    ...
    <div class="container">
        <div class="card">
            <h2 class="card-title text-center">Edit Requester</h2>
        <?php
